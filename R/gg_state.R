...
#' @param extract.metrics Expression to be used in [extract_metrics()]. Can be
...
#'            extract.metrics = list(median = ~median(MEDI))) +
#'  ggplot2::scale_fill_manual(values=c("#868686FF", "#EFC000FF", "#0073C2FF"))
...
gg_states <- function(ggplot_obj, 
  ...
  extract.metrics <- rlang::as_quosures(extract.metrics, 
